...
<qgis version="2.0.1-Dufour" minimumScale="-4.65661e-10" maximumScale="4e+06" minLabelScale="1" maxLabelScale="1e+08" hasScaleBasedVisibilityFlag="1" scaleBasedLabelVisibilityFlag="0">
  <renderer-v2 attr="LANDUSE" symbollevels="0" type="categorizedSymbol">
    <categories>
      <category symbol="0" value="industrial" label=""/>
    </categories>
    <symbols>
  ...
  <edittypes>
    ...
    <edittype labelontop="0" editable="1" type="0" name="RSDNTL"/>
  </edittypes>
  <editform>.</editform>
